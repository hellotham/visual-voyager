...
$milennial_pink_homepage_header_image_url = CHILD_URL . '/config/import/images/mountain-color.jpg';

// Photo by Haley Powers on Unsplash: https://unsplash.com/photos/rjhvXX7JBPc.
$milennial_pink_homepage_faq_image_url = CHILD_URL . '/config/import/images/home-about-color.jpg';

return <<<CONTENT
<!-- wp:media-text {"align":"full","mediaId":1657,"mediaType":"image","isStackedOnMobile":true} -->
<div class="wp-block-media-text alignfull is-stacked-on-mobile"><figure class="wp-block-media-text__media"><img src="$milennial_pink_homepage_header_image_url" alt="" class="wp-image-1657"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"level":1} -->
...
<!-- wp:atomic-blocks/ab-columns {"columns":2,"layout":"ab-2-col-equal","align":"full","paddingTop":14,"paddingRight":5,"paddingBottom":8,"paddingLeft":5,"paddingUnit":"%","customTextColor":"#f4dedefff","customBackgroundColor":"#111111","columnMaxWidth":1062} -->
<div class="wp-block-atomic-blocks-ab-columns ab-layout-columns-2 ab-2-col-equal ab-has-custom-background-color ab-has-custom-text-color ab-columns-center alignfull" style="padding-top:14%;padding-right:5%;padding-bottom:8%;padding-left:5%;background-color:#111111;color:#f4dedefff"><div class="ab-layout-column-wrap ab-block-layout-column-gap-2 ab-is-responsive-column" style="max-width:1062px"><!-- wp:atomic-blocks/ab-column -->
...
<figure class="wp-block-image size-large"><img src="$milennial_pink_homepage_faq_image_url" alt="" class="wp-image-1655"/></figure>
<!-- /wp:image --></div></div>
<!-- /wp:atomic-blocks/ab-column --></div></div>
<!-- /wp:atomic-blocks/ab-columns -->
CONTENT;
